...
const createSecureEnvelopeSQL = "INSERT INTO secure_envelopes (id, envelope_id, direction, is_error, encryption_key, hmac_secret, timestamp, public_key, envelope, created, modified) VALUES (:id, :envelopeID, :direction, :isError, :encryptionKey, :hmacSecret, :timestamp, :publicKey, :envelope, :created, :modified)"
...
const updateSecureEnvelopeSQL = "UPDATE secure_envelopes SET direction=:direction, is_error=:is_error, encryption_key=:encryptionKey, hmac_secret=:hmacSecret, timestamp=:timestamp, public_key=:publicKey, envelope=:envelope, modified=:modified WHERE id=:id and envelope_id=:envelopeID"
