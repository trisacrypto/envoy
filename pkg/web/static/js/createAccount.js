...
addWalletBttn?.addEventListener('click', () => {
  ...
  <div class="grid gap-6 my-4 md:grid-cols-2">
    <div>
      ...
      <input type="text" id="crypto_address" name="crypto_address_${walletCount}" class="input-style" />
    </div>
    <div>
      <label for="network" class="label-style">Network</label>
      <div class="flex items-center gap-x-1">
        <input type="text" id="network" name="network_${walletCount}" class="input-style" />
